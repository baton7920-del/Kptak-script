...
-- УДАЛЯЕМ СТАРЫЙ GUI (FIX)
pcall(function()
local old=p:WaitForChild("PlayerGui"):FindFirstChild("KptakGUI")
if old then old:Destroy() end
end)

-- СОЗДАЁМ GUI (БЕЗ PARENT СРАЗУ)
...
-- fallback если executor сломал PlayerGui
if not success then
pcall(function()
